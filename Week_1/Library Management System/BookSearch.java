...
public class BookSearch {
    ...
    public static void main(String[] args) {
        Book[] books = {
            new Book(1, "Java Programming", "Rahul Sharma"),
new Book(2, "Data Structures", "Priya Verma"),
new Book(3, "Algorithms", "Rohit Singh"),
new Book(4, "Operating Systems", "Ananya Gupta")
        };
